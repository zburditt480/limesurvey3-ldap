...
//$config['siteadminemail']     = 'webmaster@letu.edu'; // The default email address of the site administrator
//$config['siteadminbounce']    = 'webmaster@letu.edu'; // The default email address used for error notification of sent messages for the site administrator (Return-Path)
$config = array();
$config['siteadminemail']     = 'support@letu.edu'; // The default email address of the site administrator
$config['siteadminbounce']    = 'support@letu.edu'; // The default email address used for error notification of sent messages for the site administrator (Return-Path)
$config['siteadminname']      = 'LETU Webmaster';      // The name of the site administrator
...
$config['emailsmtphost']      = 'smtp-relay.letu.edu';      // Sets the SMTP host. You can also specify a different port than 25 by using
