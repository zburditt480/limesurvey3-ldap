...
$ldap_server[$serverId]['server'] = "ldap.letnet.net";
...
$ldap_server[$serverId]['binddn']	=	"cn=WWW_Webquery,ou=DBQueryAccounts,ou=!admin,ou=accounts,dc=letnet,dc=net";
$ldap_server[$serverId]['bindpw']	=	"Baueran9";
...
$ldap_queries[$query_id]['userbase'] = 'ou=Accounts,dc=letnet,dc=net';
...
$ldap_queries[$query_id]['attr1'] = 'employeeid';
